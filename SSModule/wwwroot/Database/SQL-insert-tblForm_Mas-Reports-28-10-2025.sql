IF Not EXISTS(Select * from tblForm_Mas where WebURL  ='/Report/WalkingCustomer/List')
 INSERT [dbo].[tblForm_Mas] ([PKFormID], [FKMasterFormID], [SeqNo], [FormName], [ShortName], [ShortCut], [ToolTip], [Image], [FormType], [WebURL], [IsActive]) VALUES (212, 1004, 12, N'Walking Customer', N'WalkingCustomer', NULL, NULL, N'<i class="fas fa-clipboard-list nav-icon"></i>', NULL, N'/Report/WalkingCustomer/List', 1)
