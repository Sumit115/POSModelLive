IF Not EXISTS(Select * from tblForm_Mas where WebURL  ='/Option/EntryLog/List')
 INSERT [dbo].[tblForm_Mas] ([PKFormID], [FKMasterFormID], [SeqNo], [FormName], [ShortName], [ShortCut], [ToolTip], [Image], [FormType], [WebURL], [IsActive]) VALUES (351, 1006, 3, N'Logs', N'Logs', NULL, NULL, N'<i class="fas fa-clipboard-list nav-icon"></i>', NULL, N'/Option/EntryLog/List', 1)
