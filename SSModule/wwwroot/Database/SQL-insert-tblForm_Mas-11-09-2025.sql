IF Not EXISTS(Select * from tblForm_Mas where WebURL  ='/Report/StockAndSalesAnalysis/List')
 INSERT [dbo].[tblForm_Mas] ([PKFormID], [FKMasterFormID], [SeqNo], [FormName], [ShortName], [ShortCut], [ToolTip], [Image], [FormType], [WebURL], [IsActive]) VALUES (211, 1004, 11, N'Stock & Sales Analysis', N'StockAndSalesAnalysis', NULL, NULL, N'<i class="fas fa-clipboard-list nav-icon"></i>', NULL, N'/Report/StockAndSalesAnalysis/List', 1)
