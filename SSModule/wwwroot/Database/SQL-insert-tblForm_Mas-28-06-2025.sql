IF Not EXISTS(Select * from tblForm_Mas where WebURL  ='/Master/CreditCardType/List')
 INSERT [dbo].[tblForm_Mas] ([PKFormID], [FKMasterFormID], [SeqNo], [FormName], [ShortName], [ShortCut], [ToolTip], [Image], [FormType], [WebURL], [IsActive]) VALUES (34, 1023, 4, N'Credit Card Type', N'Credit Card Type', NULL, NULL, N'<i class="far fa-dot-circle nav-icon"></i>', NULL, N'/Master/CreditCardType/List', 1)
