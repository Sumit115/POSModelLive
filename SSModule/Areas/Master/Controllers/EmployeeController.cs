...
namespace SSAdmin.Areas.Master.Controllers
{
    ...
    public class EmployeeController : BaseController
    {
        ...
        public EmployeeController(IEmployeeRepository repository, IGridLayoutRepository gridLayoutRepository):base(gridLayoutRepository)
        {
            _repository = repository;
            FKFormID = (long)Handler.Form.Employee;
        }
        ...
        public ActionResult Export(int pageNo, int pageSize)
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                {
                    wb.SaveAs(stream);
                    return File(stream.ToArray(), "application/ms-excel", "Employee-List.xls");// "Purchase-Invoice-List.xls");
        ...
        public async Task<IActionResult> Create(long id, string pageview = "")
        {
            ...
            try
            {
                ...
                if (id != 0 && pageview.ToLower() == "log")
                {
                    ...
                    Model = _repository.GetMasterLog<EmployeeModel>(id);
                }
                else if (id != 0)
                {
