...
namespace SSAdmin.Areas.Master.Controllers
{
    ...
    public class RegionController : BaseController
    {
        ...
        private readonly IZoneRepository _repositoryZone;
        public RegionController(IRegionRepository repository, IZoneRepository repositoryGroupRepository, IGridLayoutRepository gridLayoutRepository) : base(gridLayoutRepository)
        {
            ...
            try
            {
              //  ViewBag.ZoneList = _repositoryZone.GetDrpZone(1000, 1);
                ...
                if (id != 0 && pageview.ToLower() == "log")
                {
                    ...
                    Model = _repository.GetMasterLog<RegionModel>(id);
                }
                else if (id != 0)
                {
