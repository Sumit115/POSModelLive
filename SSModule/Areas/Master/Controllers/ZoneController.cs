...
namespace SSAdmin.Areas.Master.Controllers
{
    ...
    public class ZoneController : BaseController
    {
        ...
        public ZoneController(IZoneRepository repository  , IGridLayoutRepository gridLayoutRepository) : base(gridLayoutRepository)
        {
            _repository = repository;
             FKFormID = (long)Handler.Form.Zone;
        }
        ...
        public async Task<IActionResult> Create(long id, string pageview = "")
        {
            ...
            try
            {
                ...
                if (id != 0 && pageview.ToLower() == "log")
                {
                    ...
                    Model = _repository.GetMasterLog<ZoneModel>(id);
                }
                else if (id != 0)
                {
        ...
        [HttpPost]
        public async Task<JsonResult> GetDrpZone()
        {
            var data = _repository.GetDrpZone(1000);
