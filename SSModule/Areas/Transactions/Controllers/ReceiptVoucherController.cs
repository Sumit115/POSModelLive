...
{
    [Area("Transactions")]
    public class ReceiptVoucherController : BaseTranController<IVoucherRepository, IGridLayoutRepository>
    {
        private readonly IVoucherRepository _repository;

        public ReceiptVoucherController(IVoucherRepository repository, IGridLayoutRepository gridLayoutRepository) : base(repository, gridLayoutRepository)
        {
