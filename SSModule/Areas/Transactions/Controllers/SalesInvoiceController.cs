...
namespace SSAdmin.Areas.Transactions.Controllers
{
    ...
    public class SalesInvoiceController : SalesInvController
    {
        ...
        public SalesInvoiceController(ISalesInvoiceRepository repository, IGridLayoutRepository gridLayoutRepository, ICompositeViewEngine viewEngine, IWebHostEnvironment webHostEnvironment) : base(repository, gridLayoutRepository, viewEngine, webHostEnvironment)
        {
            TranType = "S";
            TranAlias = "SINV";
            StockFlag = "O";
