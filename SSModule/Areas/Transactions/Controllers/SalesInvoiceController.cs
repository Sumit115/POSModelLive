...
namespace SSAdmin.Areas.Transactions.Controllers
{
    ...
    public class SalesInvoiceController : BaseController
    {
        ...
        public SalesInvoiceController(ISalesInvoiceRepository repository, ICustomerRepository customerRepository, IProductRepository productRepository, ISeriesRepository seriesRepository, IGridLayoutRepository gridLayoutRepository) : base(gridLayoutRepository)
        {
        ...
        public async Task<IActionResult> Create(long id, string pageview = "")
        {
            ...
            try
            {
                ...
                ViewBag.SeriesList = _seriesRepository.GetList_by_TranAlias("SINV");
