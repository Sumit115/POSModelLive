...
{
    [Area("Transactions")]
    public class JobWorkController : BaseTranController<IJobWorkRepository, IGridLayoutRepository, ICompositeViewEngine, IWebHostEnvironment>
    {
        public readonly IJobWorkRepository _repository;

        public JobWorkController(IJobWorkRepository repository, IGridLayoutRepository gridLayoutRepository, ICompositeViewEngine viewEngine, IWebHostEnvironment webHostEnvironment) : base(repository, gridLayoutRepository, viewEngine, webHostEnvironment)
        {
            TranType = "P";
            TranAlias = "PJ_O";
            StockFlag = "N";
