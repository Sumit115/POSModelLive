...
namespace SSAdmin.Areas.Transactions.Controllers
{
    ...
    public class PurchaseOrderController : BaseController
    {
        ...
        public PurchaseOrderController(IPurchaseOrderRepository repository, IVendorRepository vendorRepository, IProductRepository productRepository, ISeriesRepository seriesRepository, IGridLayoutRepository gridLayoutRepository) : base(gridLayoutRepository)
        {
        ...
        public async Task<IActionResult> Create(long id, string pageview = "")
        {
            ...
            try
            {
                ...
                ViewBag.SeriesList = _seriesRepository.GetList_by_TranAlias("PORD");
