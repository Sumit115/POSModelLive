...
namespace SSAdmin.Areas.Transactions.Controllers
{
    ...
    public class PurchaseInvoiceController : BaseController
    {
        ...
        public PurchaseInvoiceController(IPurchaseInvoiceRepository repository, IVendorRepository vendorRepository, IProductRepository productRepository, ISeriesRepository seriesRepository, IGridLayoutRepository gridLayoutRepository) : base(gridLayoutRepository)
        {
        ...
        public async Task<IActionResult> Create(long id, string pageview = "")
        {
            ...
            try
            {
                ViewBag.PartiList = JsonConvert.SerializeObject(_vendorRepository.AutoDropDown());
                ViewBag.ProductList = JsonConvert.SerializeObject(_productRepository.GetList(1000, 1));
                ViewBag.SeriesList = _seriesRepository.GetList_by_TranAlias("PINV");
        ...
        //            HttpContext.Session.Set<DateTime>("PurchaseInvDate_Modified" + id, Trans.DATE_MODIFIED);
        //        }
        //        else
        //        {
        ...
        //            if (HttpContext.Session.GetString("PurchaseInvLastPrintID") != null)
        //            {
        //                ViewBag.LastPrintID = HttpContext.Session.GetString("PurchaseInvLastPrintID");
        //                HttpContext.Session.Remove("PurchaseInvLastPrintID");
        //            }
