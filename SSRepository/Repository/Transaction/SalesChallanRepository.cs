...
{
    public class SalesChallanRepository : TranBaseRepository, ISalesChallanRepository
    {
        public SalesChallanRepository(AppDbContext dbContext) : base(dbContext)
        {
            __FormID = (long)en_Form.SalesChallan;
            __FormID_Create = (long)en_Form.SalesChallan_Create;
            SaveSP = "usp_SalesChallanAddUpd";
            GetSP = "usp_SalesChallanList";
        }
        ...
        public TranModel GetSingleRecord(long PkId, long FkSeriesId)
        {
            ...
            var entity = (from odr in __dbContext.TblSalesChallantrn
            ...
            if (entity != null)
            {
                ...
                data.TranDetails = (from odrdtl in __dbContext.TblSalesChallandtl
        ...
        public List<ColumnStructure> ColumnList()
        {
            var list = new List<ColumnStructure>
            {
                 ...
                 new ColumnStructure{ pk_Id=5, Orderby =5, Heading ="Challan No.", Fields="Inum",Width=10,IsActive=1, SearchType=1,Sortable=1,CtrlType="~" },
