...
namespace SSRepository.Repository.Transaction
{
    public class PurchaseInvoiceRepository : TranBaseRepository, IPurchaseInvoiceRepository
    {
        ...
        {
            __FormID = (long)en_Form.PurchaseInvoice;
            __FormID_Create = (long)en_Form.PurchaseInvoice_Create;
        ...
        public TranModel GetSingleRecord(long PkId, long FkSeriesId)
        {
            ...
            var entity = (from odr in __dbContext.TblPurchaseInvoicetrn
            ...
            if (entity != null)
            {
                ...
                data.TranDetails = (from odrdtl in __dbContext.TblPurchaseInvoicedtl
