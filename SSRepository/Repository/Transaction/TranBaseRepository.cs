    ...
    public class TranBaseRepository : BaseRepository
    {
        ...
        public List<ColumnStructure> TrandtlColumnList(string TranType)
        {
            ...
            if (TranType == "P")
            {
                ...
                {
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="ArticalNo",       Fields="Product",             Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="CD"   ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Size",            Fields="Batch",               Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="C"    ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Color",           Fields="Color",               Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="T"    ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="MRP",             Fields="MRP",                 Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2"  ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Purchase Rate",   Fields="Rate",                Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2"  ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Sale Rate",       Fields="SaleRate",            Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2"  ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Trade Rate",      Fields="TradeRate",           Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2"  ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Distribution Rate",Fields="DistributionRate",    Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2" ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="QTY",             Fields="Qty",                 Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2"  ,TotalOn="Qty"},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Free Qty",        Fields="FreeQty",             Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2"  ,TotalOn="FreeQty"},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Disc %",          Fields="TradeDisc",           Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2"  ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Disc Amt",        Fields="TradeDiscAmt",        Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""     ,TotalOn="TradeDiscAmt"},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Disc Type",       Fields="TradeDiscType",       Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""     ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Gross Amt",       Fields="GrossAmt",            Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""     ,TotalOn="GrossAmt"},
                    ...
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="GST Amount",      Fields="GstAmt",              Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""     ,TotalOn="GstAmt"},
                    ...
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Del",             Fields="Delete",              Width=5, IsActive=1, SearchType=0,  Sortable=0, CtrlType="BD"   ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Due Qty",         Fields="DueQty",             Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""      ,TotalOn="DueQty"},
            ...
            else if (TranType == "R")
            {
                list = new List<ColumnStructure>
                {
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="InvoiceDate",  Fields="InvoiceDate",         Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="D1"  ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="FKInvoiceID",  Fields="FKInvoiceID_Text",    Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="CD"  ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="ArticalNo",    Fields="Product",             Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="CD"  ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Size",         Fields="Batch",               Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="CD"  ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Color",        Fields="Color",               Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="CD"  ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="MRP",          Fields="MRP",                 Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="CD"  ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Rate",         Fields="Rate",                Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""    ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="QTY",          Fields="Qty",                 Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2" ,TotalOn="Qty"},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Free Qty",     Fields="FreeQty",             Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2" ,TotalOn="FreeQty"},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++, Heading ="Disc %",       Fields="TradeDisc",           Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2"  ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++, Heading ="Disc Amt",     Fields="TradeDiscAmt",        Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""     ,TotalOn="TradeDiscAmt"},
            ...
            else if (TranType == "SORD")
            {
                ...
                list = new List<ColumnStructure>
                {
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="ArticalNo",    Fields="Product",             Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="CD"   ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Size",         Fields="Batch",               Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="C"    ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Color",        Fields="Color",               Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""     ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="MRP",          Fields="MRP",                 Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2"  ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Rate",         Fields="Rate",                Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2"  ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="QTY",          Fields="Qty",                 Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2"  ,TotalOn="Qty"},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Free Qty",     Fields="FreeQty",             Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2"  ,TotalOn="FreeQty"},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Due Qty",         Fields="DueQty",             Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""   ,TotalOn="DueQty"},
                    new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Disc %",       Fields="TradeDisc",           Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2"  ,TotalOn=""},
            ...
            else if (TranType == "Walkingdtl")
            {
                list = new List<ColumnStructure>
                {
                    ...
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++,  Heading ="MRP",          Fields="MRP",                 Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2" ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++,  Heading ="Rate",         Fields="Rate",                Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2" ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++,  Heading ="QTY",          Fields="Qty",                 Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""    ,TotalOn="Qty"},
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++,  Heading ="Free Qty",     Fields="FreeQty",             Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2" ,TotalOn="FreeQty"},
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++,  Heading ="Due Qty",         Fields="DueQty",             Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""  ,TotalOn="DueQty"},
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++,  Heading ="Disc %",       Fields="TradeDisc",           Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="F.2" ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++,  Heading ="Disc Amt",     Fields="TradeDiscAmt",        Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""    ,TotalOn="TradeDiscAmt"},
                    ...
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++, Heading ="Net Amount",   Fields="NetAmt",              Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""     ,TotalOn="NetAmt"},
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++, Heading ="Barcode",      Fields="Barcode",             Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""     ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++, Heading ="PromotionName",      Fields="PromotionName", Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""     ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++, Heading ="Del",          Fields="Delete",              Width=5, IsActive=1, SearchType=0,  Sortable=0, CtrlType="BD"   ,TotalOn=""},
            ...
            else if (TranType == "LocRecdtl")
            {
                list = new List<ColumnStructure>
                {
                    ...
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++,  Heading ="Rate",         Fields="Rate",                Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""   ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++,  Heading ="QTY",          Fields="Qty",                 Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""   ,TotalOn="Qty"},
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++,  Heading ="Free Qty",     Fields="FreeQty",             Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""   ,TotalOn="FreeQty"},
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++,  Heading ="Due Qty",         Fields="DueQty",             Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType="" ,TotalOn="DueQty"},
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++,  Heading ="Disc %",       Fields="TradeDisc",           Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""   ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++,  Heading ="Disc Amt",     Fields="TradeDiscAmt",        Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""   ,TotalOn="TradeDiscAmt"},
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++, Heading ="Disc Type",    Fields="TradeDiscType",       Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""    ,TotalOn=""},
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++, Heading ="Gross Amt",    Fields="GrossAmt",            Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""    ,TotalOn="GrossAmt"},
                    new ColumnStructure{ pk_Id=index++,   Orderby =Orderby++, Heading ="GST Rate",     Fields="GstRate",             Width=10,IsActive=1, SearchType=1,  Sortable=1, CtrlType=""    ,TotalOn=""},
