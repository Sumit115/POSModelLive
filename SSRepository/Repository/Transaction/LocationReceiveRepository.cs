        ...
        public List<ColumnStructure> ColumnList(string GridName = "")
        {
            ...
            else
            {
                list = new List<ColumnStructure>
                {
                     ...
                     new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Location", Fields="LocationName",Width=10,IsActive=1, SearchType=1,Sortable=1,CtrlType="~" ,TotalOn=""},
                     ...
                     new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Amt", Fields="GrossAmt",Width=10,IsActive=0, SearchType=1,Sortable=1,CtrlType="~" ,TotalOn="GrossAmt"},
                     new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Tax Amt", Fields="TaxAmt",Width=10,IsActive=0, SearchType=1,Sortable=1,CtrlType="~" ,TotalOn="TaxAmt"},
                     new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Discount Amt", Fields="TotalDiscount",Width=10,IsActive=0, SearchType=1,Sortable=1,CtrlType="~" ,TotalOn="TotalDiscount"},
                     new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="RoundOf Amt", Fields="RoundOfDiff",Width=10,IsActive=0, SearchType=1,Sortable=1,CtrlType="~" ,TotalOn="RoundOfDiff"},
                     new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Shipping Amt ", Fields="Shipping",Width=10,IsActive=0, SearchType=1,Sortable=1,CtrlType="~" ,TotalOn="Shipping"},
                     ...
                     new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++,  Heading ="Remark", Fields="Remark",Width=25,IsActive=1, SearchType=1,Sortable=1,CtrlType="~" ,TotalOn=""},
                     ...
                     //new ColumnStructure{ pk_Id=14, Orderby =14, Heading ="Schedule Date", Fields="OrderScheduleDt",Width=10,IsActive=1, SearchType=1,Sortable=1,CtrlType="~" ,TotalOn=""},
                     //new ColumnStructure{ pk_Id=15, Orderby =15, Heading ="Concern Person Name", Fields="ConcernPersonName",Width=10,IsActive=1, SearchType=1,Sortable=1,CtrlType="~" ,TotalOn=""},
                     //new ColumnStructure{ pk_Id=16, Orderby =16, Heading ="Concern Person Mobile", Fields="ConcernPersonMobile",Width=10,IsActive=1, SearchType=1,Sortable=1,CtrlType="~" ,TotalOn=""},
