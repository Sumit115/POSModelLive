        ...
        public List<ColumnStructure> ColumnList(string GridName = "")
        {
            ...
            else
            {
                ...
                list = new List<ColumnStructure>
                {
                     ...
                     new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++, Heading ="Schedule Date", Fields="OrderScheduleDt",Width=10,IsActive=1, SearchType=1,Sortable=1,CtrlType="~" ,TotalOn=""},
                     new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++, Heading ="Concern Person Name", Fields="ConcernPersonName",Width=10,IsActive=1, SearchType=1,Sortable=1,CtrlType="~" ,TotalOn=""},
                     new ColumnStructure{ pk_Id=index++,  Orderby =Orderby++, Heading ="Concern Person Mobile", Fields="ConcernPersonMobile",Width=10,IsActive=1, SearchType=1,Sortable=1,CtrlType="~" ,TotalOn=""},
