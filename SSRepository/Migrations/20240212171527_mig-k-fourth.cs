...
{
    /// <inheritdoc />
    public partial class migkfourth : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblPurchaseInvoice_dtl", x => x.PkId);
                });

            migrationBuilder.CreateTable(
                name: "tblPurchaseInvoice_trn",
                schema: "dbo",
                columns: table => new
                {
                    PkId = table.Column<long>(type: "bigint", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblPurchaseInvoice_trn", x => x.PkId);
                });

            migrationBuilder.CreateTable(
                name: "tblPurchaseOrder_dtl",
                schema: "dbo",
                columns: table => new
                {
                    PkId = table.Column<long>(type: "bigint", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblPurchaseOrder_dtl", x => x.PkId);
                });

            migrationBuilder.CreateTable(
                name: "tblPurchaseOrder_trn",
                schema: "dbo",
                columns: table => new
                {
                    PkId = table.Column<long>(type: "bigint", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblPurchaseOrder_trn", x => x.PkId);
                });

            migrationBuilder.CreateTable(
                name: "tblSalesChallan_dtl",
                schema: "dbo",
                columns: table => new
                {
                    PkId = table.Column<long>(type: "bigint", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblSalesChallan_dtl", x => x.PkId);
                });

            migrationBuilder.CreateTable(
                name: "tblSalesChallan_trn",
                schema: "dbo",
                columns: table => new
                {
                    PkId = table.Column<long>(type: "bigint", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblSalesChallan_trn", x => x.PkId);
                });
        }
