...
public class Handler
{
    ...
    public static DataTable ExecuteDataTable(string connectionString, string spName, string[] paramNames = null, object[] paramValues = null)
    {
        DataSet ds = ExecuteDataSet(connectionString,spName, paramNames, paramValues);
        return ds.Tables[0];
    }
    public static DataSet ExecuteDataSet(string connectionString, string spName, string[] paramNames = null, object[] paramValues = null)
    {
        ...
        using (SqlConnection conn = new SqlConnection(connectionString))
        {
            using (SqlCommand cmd = new SqlCommand(spName, conn))
            {
                ...
                // Add parameters dynamically using two arrays
